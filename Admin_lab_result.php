      ...
      <div class="container mt-5 ml-5"> 
            ...
            <div class="col-sm-8">
              <div class="card">
                <div class="card-body">
                    <center>
                            <h3 class="text-uppercase" >Send Lab Test Result</h3>
                        </center>
                        <br/>
                       
                        <form action="./action.php/admin_send_lab_result.php"  method="post" class="ml-5" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <span for="exampleFormControlInput1" class="form-label ">Result</span><br/>
