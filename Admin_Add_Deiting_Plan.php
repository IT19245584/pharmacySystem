      ...
      <div class="container mt-5 ml-5"> 
            ...
            <div class="col-sm-8">
              <div class="card">
                <div class="card-body">
                    <center>
                            <h3 class="text-uppercase" >Add Dieting Plan</h3>
                        </center>
                        <br/>
                         <?php
                            include './action.php/db.php';
                            $id = $_REQUEST['id'];
                            $sql = "select * from dietingplan where id = '$id'";            
                            $result = $conn->query($sql);
                            if ($result->num_rows > 0) {
                                // output data of each row
                                while ($row = $result->fetch_assoc()) {
                        ?>
                        <form action="./action.php/admin_add_deiting.php"  method="post" class="ml-5" enctype="multipart/form-data">
                           <div class="mb-3">
                             <i class="fas fa-angle-double-right"></i> User Id : &nbsp;&nbsp; <?php echo $row["id"] ?> <br/>
