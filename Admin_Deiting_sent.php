...
<div class="wrapper">
    ...
    <div class="tab-content">
      <div class="container mt-5 ml-5"> 
            <h2 class="text-bold text-uppercase" style="text-decoration: underline;">Sent Deiting Plan</h2>
           <a href="./Admin_Deiting.php">
            ...
            <div class="row mt-5" style="width: 99%;">
              <?php
                  ...
                  $sql = "select * from dietingplan where status = 'Sent'";            
               ...
               <div class="col-sm-3">
                ...
                <?php 
                    ...
                    <?php 
                        ...
                        ?>
                        <img src="./action.php/upload/dieting/<?php echo $row["img"] ?>" class="card-img-top" alt="...">
                        <?php 
                    }
                ?>
                  <div class="card-body">
