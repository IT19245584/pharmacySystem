              ...
              <div class="card">
                <div class="card-body">
                    <center>
                        ...
                        <br/>
                        <form action="./action.php/admin_doctor_registration.php"  method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" rows="5" name="Specialist" id="Specialist" ></textarea>
                            </div>
                            <div class="mb-3">
