            ...
            <div class="col-4 ">
                <div class="card border-0 shadow" >
                    <div class="card-body">
                        ...
                        <form action="./action.php/registration.php" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <span for="exampleFormControlInput1" class="form-label">User Type</span>
                        ...
                        <div class="d-grid gap-2">
                             <button disabled="true" class="btn btn-dark btn-sm" id="register" type="submit">Registration</button>
                        </div>
                        </form>
                        <div class="text-end">
